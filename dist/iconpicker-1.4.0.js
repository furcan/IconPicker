...
var IconPicker = {
    ...
    Run: function (theButton, theCallback) {
            ...
            if (ipButtons && ipButtons.length > 0) {
                for (var i = 0; i < ipButtons.length; i++) {
                    ...
                    ipButton.addEventListener('click', function () {
                        ...
                        getIconListXmlHttpRequest(jsonUrl, showAllButton, cancelButton, searchPlaceholder, inputElement, previewElement, theCallback);
        ...
        function getIconListXmlHttpRequest(jsonUrl, buttonShowAll, buttonCancel, searchPlaceholder, inputElement, previewElement, theCallback) {
                ...
                xmlHttp.onreadystatechange = function () {
                    if (this.readyState === 4) {
                        if (this.status === 200) { // success
                            ...
                            appendIconListToBody(data, buttonShowAll, buttonCancel, searchPlaceholder, inputElement, previewElement, theCallback);
                        } else {
        ...
        function appendIconListToBody(data, buttonShowAll, buttonCancel, searchPlaceholder, inputElement, previewElement, theCallback) {
