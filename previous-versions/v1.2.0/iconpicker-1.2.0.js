...
var IconPicker = {
    ...
    Run: function (theButton) {
                ...
                for (var i = 0; i < ipButtons.length; i++) {
                    ...
                    ipButton.addEventListener('click', function () {
                        ...
                        if (checkPreviewIcon.length <= 0) {
                            ipConsoleError('You must define your Preview Icon element with it\'s ID or Class Name to your Button element data attribute. \n\nExample: \ndata-iconpicker-preview="i#MyIconElement" or \ndata-iconpicker-preview="i.my-icon-element" \n\nVisit to learn how: ' + ipGithubUrl);
                        }
                ...
                xmlHttp.onreadystatechange = function () {
                    if (this.readyState === 4) {
                        if (this.status === 200) { // success
                            ...
                            appendIconListToBody(data, buttonShowAll, buttonCancel, searchPlaceholder, inputElement, previewElement);
                        } else {
        ...
        function appendIconListToBody(data, buttonShowAll, buttonCancel, searchPlaceholder, inputElement, previewElement) {
